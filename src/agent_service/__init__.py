...
async def list_user_sessions(user_id: str = Header(None)):
...
async def get_session_history(session_id: str, user_id: str = Header(None)):
...
async def clear_session(session_id: str, user_id: str = Header(None)):
...
async def clear_all_user_sessions(user_id: str = Header(None)):
